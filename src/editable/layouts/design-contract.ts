...
/**
 * Slot 4 editable design system — "Snap" theme.
 * Modern, rounded, soft-shadow media-distribution UI with a deep teal primary
 * and a warm amber secondary on a clean, cool off-white surface.
...
export const editableRootStyle = {
  ...
  '--editable-border': 'rgba(13,27,24,0.12)',
  '--editable-page-bg': '#f1f6f5',
  '--editable-page-text': '#0d1b18',

  '--slot4-page-bg': '#f1f6f5',
  '--slot4-page-text': '#0d1b18',
  '--slot4-panel-bg': '#e3efec',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#46554f',
  '--slot4-soft-muted-text': '#6c7a74',
  '--slot4-accent': '#0d9488',
  '--slot4-accent-fill': '#0d9488',
  '--slot4-accent-strong': '#0f766e',
  '--slot4-accent-soft': '#cfeae5',
  '--slot4-accent-2': '#f59e0b',
  '--slot4-accent-2-soft': '#fdecc8',
  '--slot4-dark-bg': '#0b1a17',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dde9e6',
  '--slot4-cream': '#f1f6f5',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#0d9488',
  '--slot4-gray': '#e3efec',
  '--slot4-ring': 'rgba(13,148,136,0.16)',
  '--slot4-hero-gradient': 'linear-gradient(135deg, #0d9488 0%, #14b8a6 48%, #f59e0b 130%)',
  '--slot4-body-gradient': 'linear-gradient(180deg, #f1f6f5 0%, #ffffff 60%, #e7f1ee 100%)',
} as CSSProperties
...
export const editablePalette = {
  ...
  shadow: 'shadow-[0_14px_40px_rgba(11,26,23,0.08)]',
  shadowStrong: 'shadow-[0_30px_80px_rgba(11,26,23,0.16)]',
  overlay: 'bg-[linear-gradient(180deg,rgba(7,18,15,0.04),rgba(7,18,15,0.82))]',
} as const
...
export const editableDesignContract = {
  ...
  button: {
    primary: `inline-flex items-center justify-center gap-2 rounded-full bg-[var(--slot4-accent-fill)] px-7 py-3.5 text-sm font-bold tracking-[0.01em] text-white shadow-[0_12px_30px_rgba(13,148,136,0.28)] transition hover:-translate-y-0.5 hover:bg-[var(--slot4-accent-strong)]`,
  ...
  motion: {
    lift: 'transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_28px_60px_rgba(11,26,23,0.16)]',
...
export const aiLayoutRules = [
  ...
  'Use the modern Snap theme: airy light surfaces, rounded cards, soft shadows, deep teal primary and warm amber secondary accents.',
